...
1 verbose cli [ '/usr/bin/node', '/usr/bin/npm', 'run', 'mysql' ]
2 info using npm@3.5.2
3 info using node@v8.10.0
4 verbose stack Error: missing script: mysql
...
5 verbose cwd /home/tarun/Documents/MountBlueProjects/06-web-application/node_modules
6 error Linux 4.15.0-42-generic
7 error argv "/usr/bin/node" "/usr/bin/npm" "run" "mysql"
8 error node v8.10.0
9 error npm  v3.5.2
10 error missing script: mysql
